  ...
  <div className="min-h-screen flex flex-col bg-[#f9fafb]">
    ...
    <main className="flex-grow max-w-4xl mx-auto px-4 py-16 space-y-12 text-gray-800">
      ...
      <section className="space-y-4">
        ...
        <p>
          Applications are open throughout the year. However, new student applications for Form 2
      ...
      <section>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          <Link to="/grade9" className="block bg-[#E4AF23] p-4 rounded-lg shadow hover:shadow-md text-center">
            Join Grade 9
          </Link>
          <Link to="/grade10" className="block bg-white p-4 rounded-lg shadow hover:shadow-md text-center">
            Join Grade 10
          </Link>
          <Link to="/form2" className="block bg-white p-4 rounded-lg shadow hover:shadow-md text-center">
            Join Form 2
          </Link>
          <Link to="/form3" className="block bg-white p-4 rounded-lg shadow hover:shadow-md text-center">
            Join Form 3
          </Link>
          <Link to="/form4" className="block bg-white p-4 rounded-lg shadow hover:shadow-md text-center">
            Join Form 4
          </Link>
          <Link to="/enquire" className="block bg-white p-4 rounded-lg shadow hover:shadow-md text-center">
            Enquire
          </Link>
        </div>
      </section>

...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-xl shadow-2xl bg-[#093056] w-3/4 max-w-2xl overflow-hidden"
      ...
      >
        ...
        {/* Footer Buttons */}
        <div className="flex justify-end gap-4  bg-[#093056]  px-6 py-4 bg-gray-50 border-t border-gray-200">
          <button
            onClick={onClose}

...
const Navbar: React.FC = () => {
  ...
  const [mobileGetAccessOpen, setMobileGetAccessOpen] = useState(false);
        ...
        <nav className="flex gap-6 text-sm font-semibold">
          ...
          <div ref={studentRef} className="relative group">
            ...
            >
              ...
              <NavLink to="#basketball-life" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileStudentOpen(false)}>Basketball Life</NavLink>
              <NavLink to="#rugby-life" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileStudentOpen(false)}>Rugby Life</NavLink>
              <NavLink to="#photography-life" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileStudentOpen(false)}>Photography Life</NavLink>
              <NavLink to="#korea-exchange-program" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileStudentOpen(false)}>Korea Exchange Program</NavLink>
              <NavLink to="#swimmers-life" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileStudentOpen(false)}>Swimmers Life</NavLink>
              <NavLink to="#golf-life" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileStudentOpen(false)}>Golf Life</NavLink>
            </div>
          </div>
          ...
          <div ref={boardingRef} className="relative group">
           ...
           {/* Join Us */}
          <div ref={joinUsRef} className="relative group">
            <button
              onClick={() => setMobileJoinUsOpen(o => !o)}
              className="flex items-center gap-1 hover:underline focus:outline-none"
            >
              <span>Join Us</span>
              <ChevronDownIcon
                className={`w-4 h-4 transition-transform ${mobileJoinUsOpen ? 'rotate-180' : 'rotate-0'}`}
              />
            </button>
            <div className={`
                absolute left-0 mt-1 w-48 bg-[#E4AF23] text-[#093056] rounded shadow-lg
                transition-opacity duration-200
                ${mobileJoinUsOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}
                group-hover:opacity-100 group-hover:pointer-events-auto
              `}
            >
              <NavLink to="/join" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileJoinUsOpen(false)}>Join Us</NavLink>
              <NavLink to="/grade9" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileJoinUsOpen(false)}>Join Grade 9</NavLink>
              <NavLink to="/grade10" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileJoinUsOpen(false)}>Join Grade 10</NavLink>
              <NavLink to="/form3" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileJoinUsOpen(false)}>Join Form 3</NavLink>
              <NavLink to="/form4" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileJoinUsOpen(false)}>Join Form 4</NavLink>
              <NavLink to="https://enquireto.pioneergroupofschools.co.ke/SignIn?ReturnUrl=%2F" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileJoinUsOpen(false)}>Enquire</NavLink>
            </div>
          ...
          {/* GetAccess*/}
          <div ref={accessref} className="relative group">
          <button
              onClick={() => setMobileGetAccessOpen(o => !o)}
              className="flex items-center gap-1 hover:underline focus:outline-none"
            > 
            <span>Get Access</span>
              <ChevronDownIcon
                className={`w-4 h-4 transition-transform ${mobileGetAccessOpen ? 'rotate-180' : 'rotate-0'}`} 
                />
            </button>
            <div className={`
                absolute left-0 mt-1 w-48 bg-[#E4AF23] text-[#093056] rounded shadow-lg
                transition-opacity duration-200
                ${mobileGetAccessOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}
                group-hover:opacity-100 group-hover:pointer-events-auto
              `}
            >
              <NavLink to="/access" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileJoinUsOpen(false)}>Get Access</NavLink>
              <NavLink to="/events" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileJoinUsOpen(false)}>Calendar of Events</NavLink>
              <NavLink to="/StuAccess" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileJoinUsOpen(false)}>Student Access</NavLink>
              <NavLink to="/staffAccess" className="block px-4 py-2 hover:bg-[#093056] hover:text-white" onClick={() => setMobileJoinUsOpen(false)}>Staff Access</NavLink>  
            </div>

...
const Leadership: React.FC = () => {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* Hero */}
      <section className="relative h-[30vh] bg-center bg-cover" style={{ backgroundImage: "url('/images/leadership-hero.jpg')" }}>
        <div className="absolute inset-0 bg-black/60" />
        <div className="relative bg-[#277291] z-10 flex items-center justify-center h-full">

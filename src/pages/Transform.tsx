  ...
  return (
    ...
    <main className="bg-white">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/men-in-suits.jpg')" }}
      >
      ...
      <a
        href="tel:+254205038228"
        className="fixed bottom-6 right-6 bg-orange-400 p-4 rounded-full shadow-lg hover:bg-opacity-90 transition"
      >
